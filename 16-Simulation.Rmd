...
# We can simulate a categorical variable in multiple ways

# method 1:

 educationA <- sample(c(1,2,3),size=100,prob=c(0.1,0.2,0.7),replace=TRUE) # Note probabilities must sum to one.


# method 2:

library(LaplacesDemon)
educationA <- rcat(n=100,p=c(0.1,0.2,0.7)) # Note probabilities must sum to one.
  

```

```{r sim_gaussian,echo=TRUE}
