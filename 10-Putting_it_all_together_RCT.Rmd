...
Understanding the notion of chance is key to understanding statistics.  Suppose we have a pack of cards and I deal each of us a pair cards, and we total the points on our cards. Assuming we have a fair pack of cards, that picture cards are 10 points and ace cards are 1 point, we can know what the pattern of results would look like if we re-ran this experiment 100 times. It is shown in Figure \@ref(fig:cards_sim).

```{r cards_sim,echo=TRUE,fig.cap='Plot showing the result of sequential scores for each player. Dashed lines are the average score for each player.', results="asis"}
library(tidyverse)
set.seed(123)
