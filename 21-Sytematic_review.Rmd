...
@Kysh_2013 highlighted the critical differences between a formal systematic review and a literature review. A systematic review is very specific to a particular research question and will often incorporate a meta-analytic procedure, and the end result with be a stand-alone publication. A well-executed systematic review is considered to be one of the most reliable sources of evidence beyond the RCT. The time line for a systematic review is typically quite long (months to years) as all relevant databases must be searched and strictly pre-defined protocols followed. 

A literature review is less structured and focuses on qualitative appraisal of either a general topic or specific question in the literature, providing an overview that may be published independently, or form the Introduction for a new piece of research. Systematic reviews have tended to be seen as quite separate from more traditional literature reviews, because of the rigorous set of procedures that must be followed, but we have argued here that it is possible to learn from that approach, even if we do not intend to follow all the criteria that are required for systematic review.
