...
```{r crossover_table,echo=F,message=F,warning=F}
...
```{r crossover_plot, echo=F, message=F, warning=F, fig.width=6,fig.height=5, fig.cap="plotting showing a crossover design RCT"}
