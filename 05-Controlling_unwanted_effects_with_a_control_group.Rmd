...
mod2 <- lm(y~x,newdat2)
 ...
 cross1<-ggplot(dat[!dat$intervention==2,], aes(x = x, y = y)) + 
...
geom_segment(aes(x=2,y=6,xend = 2.5, yend = 4),col="red",linetype="dashed",size=1) +
  ...
  cross2<-ggplot(dat[!dat$intervention==2,], aes(x = x, y = y)) + 
