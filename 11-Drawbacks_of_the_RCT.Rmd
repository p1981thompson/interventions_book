...
```{r diffeff,echo=FALSE,message=FALSE,warning=FALSE, fig.cap='Differences between efficacy and effectiveness studies'}
library(tidyverse)
library(knitr)
library(kableExtra)
...
Beyond clinical intervention research, behavioural and psychological intervention research is currently more flexible in the amount of outcomes that are recorded and the amount that are actually documented in the final dissemination of results.
