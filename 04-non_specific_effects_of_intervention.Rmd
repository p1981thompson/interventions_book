...
```{r placebotab, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = 'shows the placebo effect in a three-arm parallel group trial', fig.width = 5, fig.height = 3}
