...
In the following examples, is there random error, systematic bias, or both?
 ...
 2. Four research assistants measure response times on a naming task. One of the researchers makes a judgment to round up all measurements to whole seconds, whereas others report to one decimal place **(systematic | random)**,
 3. We have run an online experiment where we measure children's responses on a reading test, but the internet connection is poor and so drops out intermittently **(systematic | random)**
