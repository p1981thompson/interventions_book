...
require(ggplot2)
require(tidyverse)
figcount <- 0  #this counter is incremented when a new figure is created for this chapter
```
...
```{r weightplot,echo=FALSE, message=FALSE, warnings=FALSE, fig.cap="Random fluctuations in Bridget Jones' weight, mesaured to the nearest pound"}
...
p1<-p1 + scale_x_continuous(breaks=c(1,2))
...
Reference
Fielding, Helen (1996) Bridget Jones's Diary. Picador: London. ISBN: 0-670-88072-8.
