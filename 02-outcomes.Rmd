...
```{r correlation, echo=F,message=F,warning=F,fig.width=9,fig.height=9,fig.cap="Correlation plots"}
...
```{r anscombe_quartet, echo=F,message=F,warning=F,fig.width=9,fig.height=9,fig.cap="Anscombe's Quartet"}
anscombe$id<-1:11
