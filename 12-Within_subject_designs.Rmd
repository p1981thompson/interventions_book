...
One potential problem with the crossover design is the chance that the intervention may carry over in to the control phase which dilutes the magnitude of the effect size. This is a likely senario in educational, psychological or behavioural interventions as it is much more difficult to predict the likelihood of retention, in comparison to a drug trial where dosage and effect can be predicted from prior lab-based development. Extended washout periods are likely to provide one potential solution or choosing an alternative design such as parallel groups. 
